...
my_favourite_group = {'name': 'Г.М.О.','tracks': ['Good!', 'Шапито'], 'Albums': [{'name': 'Делать панк-рок','year': 2016}, {'name' :'Шапито','year': 2014}]}
print(my_favourite_group)


dumps_pickle = pickle.dumps(my_favourite_group)
print(dumps_pickle)
...
dumps_json = json.dumps(my_favourite_group)
print(dumps_json)
